...
BOT_TOKEN = environ.get('BOT_TOKEN', '7622157451:AAEwgnK9GQAU0e9-YQg9x10LAwQXkwUpkGM')
#---------------------------------------------------------------
#---------------------------------------------------------------
...
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/movie_finder82')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '1002545381881').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://chotabheem:chotabheem@bheem.yp7lu.mongodb.net/?retryWrites=true&w=majority&appName=Bheem")
DATABASE_NAME = environ.get('DATABASE_NAME', "Bheem")
